...
class Meldungen {
	...
	val AM011 = "The user ID must be unique."
	...
	val HH018 = "There is no suitable period. Create a new period."
	val HH019 = "Account number {0} is missing."
	val HH020 = "The account is used for bookings and cannot be deleted."
	val HH021 = "The equity capital account and profit and loss account cannot be deleted."
	...
	val HH076 = "Balance carryforward"
	val HH077 = "Date"
	val HH078 = "Revenues"
	val HH079 = "Expenditure"
	val HH080 = "Account"
	val HH081 = "Receipt number"
	val HH082 = "Posting text"
	...
	val WP023 = "Payment amount:  {0,number,#,##0.00}{1}\nShares:          {2,number,#,##0.00000}\nPrice per share: {3,number,#,##0.0000}\nInterest:        {4,number,#,##0.00}\n{5}\n{6}"
	...
	val WP027 = "Preparing ..."
	val WP028 = "Value prev. day: {0,number,#,##0.00}  +/-: {1,number,#,##0.00} ({2,date,yyyy-MM-dd})"
	val WP029 = "Records: {0,number}  Sum: {1,number,#,##0.00}  Value: {2,number,#,##0.00}  Profit: {3,number,#,##0.00} ({4,number,#,##0.00}%)  Previous day +/-: {5,number,#,##0.00}"
	...
	val WP051 = " (from {0,date,yyyy-MM-dd})"
