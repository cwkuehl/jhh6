...
public class Parameter {
    ...
    public Parameter(String schluessel, String standard, boolean inDatei, boolean inDatenbank, boolean trim,
            String kommentar, boolean verschluesselt) {
    ...
    private static HashMap<String, Parameter> params              = null;

    public static HashMap<String, Parameter> getParameter() {

        if (params == null) {
            params = new HashMap<String, Parameter>();
            Parameter[] liste = new Parameter[] {
                    new Parameter(
                            AG_ANWENDUNGS_TITEL,
                            "Java-Haushalts-Programm",
                            true,
                            true,
                            false,
                    ...
                    new Parameter(AG_HILFE_DATEI, "JHaushalt-Hilfe.html", true, false, true,
                            "Name der HTML-Hilfe-Datei, z.B. HILFE_DATEI=JHaushalt-Hilfe.html", false),
                    // new Parameter(LOOKANDFEEL, "SYSTEM", true, false, true,
                    // "Aussehen der Anwendung; JAVA oder SYSTEM, z.B. LOOKANDFEEL=JAVA", false),
                    new Parameter(AG_STARTDIALOGE, "", true, true, true,
                            "Liste der Start-Dialoge, z.B. AG_STARTDIALOGE=#FZ100", false),
                    // new Parameter(TAGEBUCH_PFAD, "", true, false, true,
